    ...
    const editCategoryMut = (e: any) => {
        ...
        editCategory({
            variables: {
                ...
                total: categoryEdit.total,
                current: categoryEdit.total,
                ...
                {queryData && queryData.getCategories.map((category: CategoryEdit) => {
                    ...
                    <li className="border border-green-800" key={category.id}>
                        ...
                        {editOpen === category.id && <>
                            ...
                            <label>amount:</label>
                            <input type="text" placeholder={(category.total)?.toString()} onChange={(e) => {
                            setCategoryEdit({
                                ...categoryEdit,
                            ...
                            <label>current:</label>
                            <input type="text" placeholder={(category.current)?.toString()} onChange={(e) => {
                            setCategoryEdit({
                                ...categoryEdit,
